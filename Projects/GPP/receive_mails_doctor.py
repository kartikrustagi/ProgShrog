...
dir_to_save_the_mails='/home/kartik/Desktop/proxy_doctor_download' #Kanika here you need to have the location for the proxy_doenload of user and doctor(This script will run seperately for both) 
import imaplib
