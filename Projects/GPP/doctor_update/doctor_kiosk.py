...
class kiosk_doctor:
	...
	def on_reply_inbox_clicked(self,widget,data=None):
	 ...
	 #according to me when each and every time a function is called the vaalue of len_of_dir for both cf and ef should be recalculated
		if self.i >= self.len_of_dir_ef:
			...
			if self.len_of_dir_cf==0:
				os.chdir("/home/kanika/Desktop/doctor_update/download/other")
				...
				os.chdir("/home/kanika/Desktop/doctor_update/download/complaint")
			...
			os.chdir("/home/kanika/Desktop/doctor_update/download/emergency")
	...
	def on_cl_view_category_changed(self,widget,data=None):	
		...
		os.chdir("/home/kanika/Desktop/doctor_update/Contact_Lists")
		list_of_dir=os.listdir("./")
	...
	def on_inbox_attached_clicked(self,widget,data=None):
		...
		if self.attached_file_name=="None":  
			...
			os.chdir("/home/kanika/Desktop/doctor_update")
