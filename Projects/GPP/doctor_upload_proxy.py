...
import gdata.media
import gdata.geo
dir_from_which_doctors_proxy_will_take_files='/home/kartik/Desktop/proxy_doctor_upload' #Kanika yaha pai tumharey doctor ke proxy ke upload directory ayegee
...
if(lendir!=0):
	for i in range(0,lendir):
		...
		if destination_email_id == 'youtube':
			...
			gd_client.email = 'kashes911@gmail.com'
			gd_client.password = 'shimpooisold'
